...
def no_clouds(T, u, q, p, ur, band = 'all'):
	...
	# array "u" está em ordem decrescente. Isso afeta as integrais e derivacoes
	# Por consistencia, queremos que o array "u" seja crescente.
	# Assim inverte-se a ordem dos elementos nos arrays dados como entrada nesta função
	T = T[::-1]
	u = u[::-1]
	q = q[::-1]
	p = p[::-1]
	...
	termo1 = -1 * calc.stefan_boltzmann(T[0]) * dEf1du
	...
	cooling_rate = cooling_rate[::-1] * 3600 * 24
