...
def figure(df):
	...
	# LEgenda e salva
	plt.legend()
	name = r'D:\Lucas\Mestrado\Disciplinas\Radiacao Solar Terrestre\Rad-PPGM\resultado_sbgl_12z_13jul23.png'
...
if __name__ == '__main__':
	...
	df['vapor_density'] = density_water_vapor(
		...
		Td  = df['dwpt'],
		p = df['pres'],
		w = df['mixr'] * 1e-3 # converte para kg / kg
	) # em Kg / m³
	...
	print(df)
	df.to_csv(r'D:\Lucas\Mestrado\Disciplinas\Radiacao Solar Terrestre\Rad-PPGM\resultado_sbgl_12z_13jul23.csv', index = False)
	figure(df)